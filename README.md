...
- **New Features (v0.3.0)**
  - **Image Manager**: View all images, compress local images (Low/Medium/High quality), grid view
  - **Table Editor**: Visual Excel-like editing, add/remove rows/cols, auto-formatting
  - **Keyboard Shortcuts**: Built-in help reference (click "⌨️ Shortcuts" in toolbar)
  - **Performance**: Large file detection (>10MB warning), optimized auto-save
- Search
