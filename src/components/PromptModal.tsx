 ...
 * 提示输入弹窗，用于 AI 续写/指令
 */
function PromptModalComponent(props: PromptModalProps) {
      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="form_row">
            ...
            <label style={{ color: '#cfcfcf', fontSize: 13 }}>
              <input
                ...
                defaultChecked
                onChange={(e) => {
                  include_document = e.target.checked
                }}
              />
              将当前文档内容作为上下文一并发送
            </label>
        ...
        <div className="modal_footer">
          ...
          <button
            ...
            onClick={() => on_submit({ prompt: prompt_value, include_document })}
          >
            发送
          </button>
        </div>
